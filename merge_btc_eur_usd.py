...
eur_file = "./converted/converted_CoinPaprika_BTC_price_custom_2024_EURO.csv"
usd_file = "./data/inputfile_legacy/btc-usd-2024-2025.csv"
output_file = "./converted/merged_btc_eur_usd.csv"
...
with open(usd_file, newline='', encoding='utf-8') as f:
    ...
    for row in reader:
        # Datum extrahieren (ohne Uhrzeit und UTC)
...
with open(eur_file, newline='', encoding='utf-8') as infile, open(output_file, 'w', newline='', encoding='utf-8') as outfile:
    ...
    for row in reader:
        ...
        # USD-Preis holen und ins deutsche Kommaformat bringen
