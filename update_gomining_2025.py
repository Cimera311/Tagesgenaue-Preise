...
new_file = "./converted/merged_gomining_eur_usd_2025.csv"
output_file = "./data/gominingtoken_eur_updated_2025.csv"

data = {}
with open(existing_file, newline='', encoding='utf-8') as f:
    reader = csv.DictReader(f, delimiter=';')
    for row in reader:
        if row['symbol'] == 'GOMINING' and row['date_iso'].startswith('2025'):
...
print("Update abgeschlossen: GOMINING 2025")