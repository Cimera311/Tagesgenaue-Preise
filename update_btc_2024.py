...
new_file = "./converted/merged_btc_eur_usd.csv"
output_file = "./data/bitcoin_eur_updated_2024.csv"

data = {}
with open(existing_file, newline='', encoding='utf-8') as f:
    reader = csv.DictReader(f, delimiter=';')
    for row in reader:
        if row['symbol'] == 'BTC' and row['date_iso'].startswith('2024'):
...
print("Update abgeschlossen: BTC 2024")